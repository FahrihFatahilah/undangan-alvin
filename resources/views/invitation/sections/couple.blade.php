...
<section class="toile-bg py-20 px-4 min-h-screen flex items-center">
    <div class="max-w-4xl mx-auto text-center">
        ...
        <div data-animate="fade-down" class="mb-12">
            <p class="font-label text-xs tracking-[0.3em] text-primary mb-4">BISMILLAHIRRAHMANIRRAHIM</p>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div data-animate="fade-right" class="text-center">
                <div class="w-48 h-48 mx-auto mb-6 rounded-full border-4 border-secondary/30 overflow-hidden bg-cream shadow-lg">
                    <div class="w-full h-full bg-gradient-to-b from-secondary/10 to-secondary/5 flex items-center justify-center">
                        <span class="font-display text-6xl text-secondary/40">I</span>
                    </div>
                </div>
            ...
            <div data-animate="fade-left" class="text-center">
                <div class="w-48 h-48 mx-auto mb-6 rounded-full border-4 border-secondary/30 overflow-hidden bg-cream shadow-lg">
                    <div class="w-full h-full bg-gradient-to-b from-secondary/10 to-secondary/5 flex items-center justify-center">
                        <span class="font-display text-6xl text-secondary/40">A</span>
                    </div>
                </div>
